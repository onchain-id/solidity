  ...
  describe("constructor", () => {
    describe("when factory address is not specified", () => {
      it("should revert", async () => {
        await expect(ethers.deployContract("Gateway", [ethers.ZeroAddress, []]))
          .to.be.reverted;
      });
    });
    ...
    describe("when specifying more than 10 signer", () => {
      it("should revert", async () => {
        const { identityFactory, carolWallet } =
          await loadFixture(deployFactoryFixture);
        await expect(
          ethers.deployContract("Gateway", [
            await identityFactory.getAddress(),
            Array(11).fill(ethers.ZeroAddress),
          ]),
        ).to.be.reverted;
      });
    });
  ...
  describe(".deployIdentityWithSalt()", () => {
    describe("when input address is the zero address", () => {
      it("should revert", async () => {
        const { identityFactory, carolWallet } =
          await loadFixture(deployFactoryFixture);
        const gateway = await ethers.deployContract("Gateway", [
          await identityFactory.getAddress(),
          [carolWallet.address],
        ]);
    ...
    describe("when signature is not valid", () => {
      it("should revert with UnsignedDeployment", async () => {
        const { identityFactory, aliceWallet, carolWallet } =
          await loadFixture(deployFactoryFixture);
        const gateway = await ethers.deployContract("Gateway", [
          await identityFactory.getAddress(),
          [carolWallet.address],
    ...
    describe("when signature is signed by a non authorized signer", () => {
      it("should revert with UnsignedDeployment", async () => {
        const { identityFactory, aliceWallet, bobWallet, carolWallet } =
          await loadFixture(deployFactoryFixture);
        const gateway = await ethers.deployContract("Gateway", [
          await identityFactory.getAddress(),
          [carolWallet.address],
        ...
        const signature = await bobWallet.signMessage(ethers.getBytes(digest));
    ...
    describe("when signature is correct and signed by an authorized signer", () => {
      it("should deploy the identity", async () => {
        ...
        await expect(tx)
          ...
          .withArgs(await identityFactory.getIdentity(aliceWallet.address));
    ...
    describe("when called by the owner", () => {
      it("should transfer ownership of the factory to the specified address", async () => {
        ...
        await expect(gateway.transferFactoryOwnership(bobWallet.address))
          .to.emit(identityFactory, "OwnershipTransferred")
          .withArgs(await gateway.getAddress(), bobWallet.address);
    ...
    describe("when not called by the owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway
            .connect(aliceWallet)
            .transferFactoryOwnership(bobWallet.address),
  ...
  describe(".revokeSignature", () => {
    describe("when calling not as owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.connect(aliceWallet).revokeSignature(signature),
        ).to.be.revertedWithCustomError(gateway, "OwnableUnauthorizedAccount");
      });
    });
    ...
    describe("when signature was already revoked", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.revokeSignature(signature),
        ).to.be.revertedWithCustomError(gateway, "SignatureAlreadyRevoked");
      });
    });
  });
  ...
  describe(".approveSignature", () => {
    describe("when calling not as owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.connect(aliceWallet).approveSignature(signature),
        ).to.be.revertedWithCustomError(gateway, "OwnableUnauthorizedAccount");
      });
    });
    ...
    describe("when signature is not revoked", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.approveSignature(signature),
        ).to.be.revertedWithCustomError(gateway, "SignatureNotRevoked");
      });
    });
  ...
  describe(".approveSigner", () => {
    describe("when signer address is zero", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.approveSigner(ethers.ZeroAddress),
    ...
    describe("when calling not as owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.connect(aliceWallet).approveSigner(bobWallet.address),
        ).to.be.revertedWithCustomError(gateway, "OwnableUnauthorizedAccount");
      });
    });
    ...
    describe("when signer is already approved", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.approveSigner(bobWallet.address),
        ).to.be.revertedWithCustomError(gateway, "SignerAlreadyApproved");
      });
    });
    ...
    describe("when signer is not approved", () => {
      it("should approve the signer", async () => {
        ...
        expect(tx)
          .to.emit(gateway, "SignerApproved")
  ...
  describe(".revokeSigner", () => {
    describe("when signer address is zero", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.revokeSigner(ethers.ZeroAddress),
        ).to.be.revertedWithCustomError(gateway, "ZeroAddress");
      });
    });
    ...
    describe("when calling not as owner", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.connect(aliceWallet).revokeSigner(bobWallet.address),
        ).to.be.revertedWithCustomError(gateway, "OwnableUnauthorizedAccount");
      });
    });
    ...
    describe("when signer is not approved", () => {
      it("should revert", async () => {
        ...
        await expect(
          gateway.revokeSigner(bobWallet.address),
  ...
  describe(".callFactory", () => {
      ...
      it("should revert", async () => {
        ...
        await expect(
          gateway
            .connect(aliceWallet)
            .callFactory(
              identityFactory.interface.encodeFunctionData("addTokenFactory", [
                ethers.ZeroAddress,
              ]),
            ),
        ).to.be.revertedWithCustomError(gateway, "OwnableUnauthorizedAccount");
    ...
    describe("when calling as the owner with correct parameters", () => {
      it("should execute the function call", async () => {
        const { identityFactory, deployerWallet, aliceWallet, bobWallet } =
          await loadFixture(deployFactoryFixture);
        ...
        expect(tx)
          .to.emit(identityFactory, "TokenFactoryAdded")
          .withArgs(bobWallet.address);
      });
    });
  });
