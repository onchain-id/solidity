  ...
  describe('.removeTrustedIssuer', () => {
    ...
    describe('when issuer is not trusted', () => {
      it('should revert', async () => {
        ...
        await expect(verifier.removeTrustedIssuer(claimIssuer.target)).to.be.revertedWithCustomError(verifier, 'NotTrustedIssuer');
      });
    });
  });
  ...
  describe('.updateIssuerClaimTopics', () => {
    ...
    describe('when issuer is not trusted', () => {
      it('should revert', async () => {
        ...
        await expect(verifier.updateIssuerClaimTopics(claimIssuer.target, [1])).to.be.revertedWithCustomError(verifier, 'NotTrustedIssuer');
      });
    });
    ...
    describe('when list of topics is empty', () => {
      it('should revert', async () => {
        ...
        await expect(verifier.updateIssuerClaimTopics(claimIssuer.target, [])).to.be.revertedWithCustomError(verifier, 'ClaimTopicsCannotBeEmpty');
      });
    });
  });
  ...
  describe('.getTrustedIssuerClaimTopic', () => {
    describe('when issuer is not trusted', () => {
      it('should revert', async () => {
        ...
        await expect(verifier.getTrustedIssuerClaimTopics(claimIssuer.target)).to.be.revertedWithCustomError(verifier, 'NotTrustedIssuer');
      });
    });
  });
});
